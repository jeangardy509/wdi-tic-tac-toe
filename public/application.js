...
var updateGameMove = function updateGameMove(index, identifier) {
  return $.ajax({
...
var resetSuccess = function resetSuccess(data) {
  $('#tictactoe').css('display', 'inline');
  $('#tictactoe').css('display', 'inline');
...
var onReset = function onReset(event) {
  event.preventDefault();
  console.log('working!');
  gameApi.reset(store).then(gameUi.resetSuccess);
};
